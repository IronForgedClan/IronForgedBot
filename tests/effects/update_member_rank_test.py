...
class UpdateMemberRankTest(unittest.IsolatedAsyncioTestCase):
    ...
    async def test_updates_rank_successfully(self, mock_db, mock_check_role, mock_get_rank, mock_emoji):
        ...
        with patch("ironforgedbot.effects.update_member_rank.MemberService", return_value=mock_service):
            await update_member_rank(self.mock_report_channel, self.member)
    ...
    @patch("ironforgedbot.effects.update_member_rank.check_member_has_role")
    @patch("ironforgedbot.effects.update_member_rank.db")
    async def test_handles_member_not_found_in_database(self, mock_db, mock_check_role, mock_get_rank):
        mock_check_role.return_value = True
        mock_get_rank.return_value = RANK.MITHRIL
        mock_session = AsyncMock()
        mock_db.get_session.return_value.__aenter__.return_value = mock_session
    ...
    @patch("ironforgedbot.effects.update_member_rank.check_member_has_role")
    @patch("ironforgedbot.effects.update_member_rank.db")
    async def test_ignores_when_rank_unchanged(self, mock_db, mock_check_role, mock_get_rank):
        mock_check_role.return_value = True
    ...
    @patch("ironforgedbot.effects.update_member_rank.check_member_has_role")
    @patch("ironforgedbot.effects.update_member_rank.db")
    async def test_converts_god_alignment_ranks_to_god(self, mock_db, mock_check_role, mock_get_rank, mock_god_alignment, mock_emoji):
        mock_check_role.return_value = True
    ...
    @patch("ironforgedbot.effects.update_member_rank.check_member_has_role")
    @patch("ironforgedbot.effects.update_member_rank.db")
    async def test_rank_update_with_emoji_display(self, mock_db, mock_check_role, mock_get_rank, mock_emoji):
        mock_check_role.return_value = True
