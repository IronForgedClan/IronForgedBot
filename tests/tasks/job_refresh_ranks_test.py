...
class TestJobRefreshRanks(unittest.IsolatedAsyncioTestCase):
    ...
    async def test_job_refresh_ranks_member_not_found(self, mock_is_banned, mock_db, mock_member_service_class, mock_history_service_class, mock_score_service_class, mock_sleep, mock_time):
    ...
    @patch("ironforgedbot.tasks.job_refresh_ranks.db")
    @patch("ironforgedbot.tasks.job_refresh_ranks.is_member_banned")
    async def test_job_refresh_ranks_banned_member_skipped(self, mock_is_banned, mock_db, mock_member_service_class, mock_history_service_class, mock_score_service_class, mock_sleep, mock_time):
        mock_time.perf_counter.side_effect = [0.0, 5.0]
    ...
    async def test_job_refresh_ranks_god_alignment_skipped(self, mock_get_rank, mock_is_banned, mock_db, mock_member_service_class, mock_history_service_class, mock_score_service_class, mock_sleep, mock_time):
        mock_time.perf_counter.side_effect = [0.0, 5.0]
    ...
    async def test_job_refresh_ranks_god_no_alignment_reported(self, mock_find_emoji, mock_get_rank, mock_is_banned, mock_db, mock_member_service_class, mock_history_service_class, mock_score_service_class, mock_sleep, mock_time):
        mock_time.perf_counter.side_effect = [0.0, 5.0]
        ...
        self.mock_report_channel.send.assert_any_call(
            "<@12345> has 👑 God rank but no alignment."
        )
    ...
    async def test_job_refresh_ranks_no_rank_reported(self, mock_text_bold, mock_find_emoji, mock_get_rank_from_points, mock_get_rank, mock_is_banned, mock_db, mock_member_service_class, mock_history_service_class, mock_score_service_class, mock_sleep, mock_time):
        mock_time.perf_counter.side_effect = [0.0, 5.0]
        mock_find_emoji.return_value = "🥉"
        ...
        self.mock_report_channel.send.assert_any_call(
            "<@12345> detected without any rank. Should have 🥉 **Mithril**."
        )
    ...
    async def test_job_refresh_ranks_hiscores_not_found_reported(self, mock_check_role, mock_get_rank, mock_is_banned, mock_db, mock_member_service_class, mock_history_service_class, mock_score_service_class, mock_sleep, mock_time):
        mock_time.perf_counter.side_effect = [0.0, 5.0]
    ...
    @patch("ironforgedbot.tasks.job_refresh_ranks.find_emoji")
    @patch("ironforgedbot.tasks.job_refresh_ranks.text_bold")
    async def test_job_refresh_ranks_member_needs_upgrading(self, mock_text_bold, mock_find_emoji, mock_check_role, mock_get_rank_from_points, mock_get_rank, mock_is_banned, mock_db, mock_member_service_class, mock_history_service_class, mock_score_service_class, mock_sleep, mock_time):
        mock_time.perf_counter.side_effect = [0.0, 5.0]
        mock_find_emoji.side_effect = lambda target: "⚪" if target == RANK.IRON else "🥉"
        mock_text_bold.side_effect = lambda x: f"**{x}**"
        mock_get_rank_from_points.return_value = RANK.MITHRIL
