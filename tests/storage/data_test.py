...
class DataTest(unittest.TestCase):
    ...
    @patch(
        ...
        read_data='[{"name": "vorkath", "display_name": "Vorkath", "display_order": 1}]',
    )
    ...
    @patch(
        "builtins.open",
        new_callable=mock_open,
        read_data='{"name": "vorkath", "display_order": 1}',
    )
    ...
    @patch(
        "builtins.open",
        new_callable=mock_open,
        read_data='[{"name": "vorkath", "display_order": 1}, {"name": "zulrah", "display_order": 2}]',
    )
