...
class TestCmdWhois(unittest.IsolatedAsyncioTestCase):
    ...
    async def test_cmd_whois_success_with_name_changes(self, mock_validate_playername, mock_client, mock_render_time, mock_build_embed):
        ...
        self.mock_wom_client.players.get_name_changes.assert_called_once_with("TestPlayer")
        mock_build_embed.assert_called_once_with(
            "📋 TestPlayer | Name History",
            "",
            discord.Colour.purple()
        )
        mock_embed.add_field.assert_called_once_with(
            name="",
            value="**2 days ago**: OldName → NewName",
            inline=False
        )
    ...
    @patch("ironforgedbot.commands.lookup.cmd_whois.Client")
    @patch("ironforgedbot.commands.lookup.cmd_whois.validate_playername")
    async def test_cmd_whois_success_no_name_changes(self, mock_validate_playername, mock_client, mock_build_embed):
        mock_validate_playername.return_value = (self.mock_member, "TestPlayer")
        mock_client.return_value = self.mock_wom_client
    ...
    @patch("ironforgedbot.commands.lookup.cmd_whois.Client")
    @patch("ironforgedbot.commands.lookup.cmd_whois.validate_playername")
    async def test_cmd_whois_success_non_member_player(self, mock_validate_playername, mock_client, mock_render_time, mock_build_embed):
    ...
    @patch("ironforgedbot.commands.lookup.cmd_whois.Client")
    @patch("ironforgedbot.commands.lookup.cmd_whois.validate_playername")
    async def test_cmd_whois_success_pending_name_change(self, mock_validate_playername, mock_client, mock_text_bold, mock_render_time, mock_build_embed):
        mock_validate_playername.return_value = (self.mock_member, "TestPlayer")
        mock_client.return_value = self.mock_wom_client
        ...
        mock_embed.add_field.assert_called_once_with(
            name="",
            value="****pending****: CurrentName → PendingName",
            inline=False
        )
    ...
    @patch("ironforgedbot.commands.lookup.cmd_whois.Client")
    @patch("ironforgedbot.commands.lookup.cmd_whois.validate_playername")
    async def test_cmd_whois_success_many_name_changes_truncated(self, mock_validate_playername, mock_client, mock_text_bold, mock_render_time, mock_build_embed):
        mock_validate_playername.return_value = (self.mock_member, "TestPlayer")
        mock_client.return_value = self.mock_wom_client
    ...
    @patch("ironforgedbot.commands.lookup.cmd_whois.validate_playername")
    async def test_cmd_whois_validation_error(self, mock_validate_playername, mock_send_error_response):
    ...
    @patch("ironforgedbot.commands.lookup.cmd_whois.Client")
    @patch("ironforgedbot.commands.lookup.cmd_whois.validate_playername")
    async def test_cmd_whois_wom_client_connection_error(self, mock_validate_playername, mock_client, mock_send_error_response):
        mock_validate_playername.return_value = (self.mock_member, "TestPlayer")
        mock_client.return_value = self.mock_wom_client
    ...
    @patch("ironforgedbot.commands.lookup.cmd_whois.Client")
    @patch("ironforgedbot.commands.lookup.cmd_whois.validate_playername")
    async def test_cmd_whois_wom_api_error(self, mock_validate_playername, mock_client, mock_send_error_response):
        mock_validate_playername.return_value = (self.mock_member, "TestPlayer")
        mock_client.return_value = self.mock_wom_client
    ...
    @patch("ironforgedbot.commands.lookup.cmd_whois.Client")
    @patch("ironforgedbot.commands.lookup.cmd_whois.validate_playername")
    async def test_cmd_whois_filters_non_approved_changes(self, mock_validate_playername, mock_client, mock_render_time, mock_build_embed):
        mock_validate_playername.return_value = (self.mock_member, "TestPlayer")
        mock_client.return_value = self.mock_wom_client
        mock_render_time.return_value = "1 day ago"
        ...
        mock_embed.add_field.assert_called_once_with(
            name="",
            value="**1 day ago**: OldName → ApprovedName",
            inline=False
        )
